...
Crear `scripts/self-improvement/hardware_report.py`, `tests/self-improvement/test_hardware_report.py` e informe por equipo en `docs/self-improvement/hardware/`.
...
`python3 -m unittest discover -s tests/self-improvement -p test_hardware_report.py` con logs guardados; campaña real aparte. El parser no debe convertir ausencia de datos en cero fallos.
