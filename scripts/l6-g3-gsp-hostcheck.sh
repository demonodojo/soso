...
for m in gsp_dma gsp_rm gsp_wpr gsp_libos fmc_lx fsp_lx gsp_rpc gsp_cmdq gsp_rm_obj \
         gsp_vram gsp_vmm gsp_top gsp_chip gsp_pramin gsp_bar1 gsp_chan gsp_ce gsp_grctx gsp_buf gsp_compute gsp_fini; do
