...
fn provided_symbols() -> HashSet<&'static str> {
    [
        ...
        "lx_iwlwifi_install_gtk", "lx_iwlwifi_authorized", "lx_iwlwifi_set_authorized",
        "lx_iwlwifi_rsn_ie", "lx_iwlwifi_rx_eapol",
        "lx_iwlwifi_connected", "lx_iwlwifi_rx", "lx_iwlwifi_tx", "lx_iwlwifi_mac",
        "lx_iwlwifi_poll", "lx_iwlwifi_set_alive", "lx_iwlwifi_set_phase",
        "iwl_ax211_deliver_rx", "iwl_ax211_deliver_eapol", "iwl_ax211_add_bss",
